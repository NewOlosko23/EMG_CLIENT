  ...
  return (
    ...
    >
      ...
      <p className="max-w-2xl mx-auto text-lg text-gray-500 mb-8">
        EMG Music empowers artists across Africa, helping them distribute their
        music globally from these locations.
      </p>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
        {countries.map((country, index) => (
          <div
            key={index}
            className={`flex flex-col items-center p-6 rounded-2xl shadow-lg backdrop-blur-md transition-all transform hover:scale-105 ${
              theme === "dark"
