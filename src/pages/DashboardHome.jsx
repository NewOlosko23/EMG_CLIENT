...
const DashboardHome = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 rounded-2xl p-4 sm:p-6 lg:p-8 text-white shadow-2xl">
        <div className="absolute inset-0 bg-black/10"></div>
        ...
        <div className="relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-purple-100 text-xs sm:text-sm font-medium">Dashboard</span>
            </div>
            
            {/* Cache Status Indicator */}
            {dataFromCache && (
              <div className="flex items-center gap-2 px-2 sm:px-3 py-1 bg-white/20 rounded-lg backdrop-blur-sm">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-3 bg-gradient-to-r from-white to-purple-100 bg-clip-text text-transparent">
            {getGreeting()}, {getDisplayName()}! 👋
          </h1>
          <p className="text-purple-100 text-sm sm:text-base lg:text-lg mb-4 sm:mb-6 max-w-2xl">
          ...
          <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2 sm:gap-3">
            <button 
              ...
              className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 bg-white/20 hover:bg-white/30 rounded-lg backdrop-blur-sm transition-all duration-200 hover:scale-105"
            >
              <Upload className="h-3 w-3 sm:h-4 sm:w-4" />
              <span className="text-xs sm:text-sm font-medium">Upload Music</span>
            </button>
            <button 
            ...
            >
              ...
              <span className="text-xs sm:text-sm font-medium">Create Campaign</span>
            </button>
            <button 
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
        <button 
          ...
          className="group bg-white rounded-xl p-3 sm:p-4 lg:p-6 shadow-sm border border-gray-200 hover:shadow-lg hover:border-purple-200 transition-all duration-300 hover:-translate-y-1 w-full text-left"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="p-2 sm:p-3 bg-gradient-to-br from-purple-100 to-purple-200 rounded-xl group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="ml-2 sm:ml-3 lg:ml-4">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{dashboardData.totalTracks}</p>
              </div>
            </div>
            <ArrowRight className="h-3 w-3 sm:h-4 sm:w-4 text-gray-400 group-hover:text-purple-600 transition-colors duration-300" />
          </div>
        </button>

        <button 
          onClick={() => navigate('/dashboard/analytics')}
          className="group bg-white rounded-xl p-3 sm:p-4 lg:p-6 shadow-sm border border-gray-200 hover:shadow-lg hover:border-green-200 transition-all duration-300 hover:-translate-y-1 w-full text-left"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="p-2 sm:p-3 bg-gradient-to-br from-green-100 to-green-200 rounded-xl group-hover:scale-110 transition-transform duration-300">
                <Play className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-green-600" />
              </div>
              <div className="ml-2 sm:ml-3 lg:ml-4">
                <p className="text-xs sm:text-sm font-medium text-gray-600">Total Plays</p>
                <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{formatNumber(dashboardData.totalPlays)}</p>
              </div>
            </div>
            <ArrowRight className="h-3 w-3 sm:h-4 sm:w-4 text-gray-400 group-hover:text-green-600 transition-colors duration-300" />
          </div>
        </button>

        <button 
          onClick={() => navigate('/dashboard/analytics')}
          className="group bg-white rounded-xl p-3 sm:p-4 lg:p-6 shadow-sm border border-gray-200 hover:shadow-lg hover:border-blue-200 transition-all duration-300 hover:-translate-y-1 w-full text-left"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div className="ml-2 sm:ml-3 lg:ml-4">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{dashboardData.totalCountries}</p>
              </div>
            </div>
            <ArrowRight className="h-3 w-3 sm:h-4 sm:w-4 text-gray-400 group-hover:text-blue-600 transition-colors duration-300" />
          </div>
        </button>

        <button 
          onClick={() => navigate('/dashboard/analytics')}
          className="group bg-white rounded-xl p-3 sm:p-4 lg:p-6 shadow-sm border border-gray-200 hover:shadow-lg hover:border-yellow-200 transition-all duration-300 hover:-translate-y-1 w-full text-left"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="p-2 sm:p-3 bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-xl group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="ml-2 sm:ml-3 lg:ml-4">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">${dashboardData.totalEarnings.toFixed(2)}</p>
              </div>
            </div>
            <ArrowRight className="h-3 w-3 sm:h-4 sm:w-4 text-gray-400 group-hover:text-yellow-600 transition-colors duration-300" />
          </div>
        </button>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="p-4 sm:p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <button 
              onClick={() => navigate('/dashboard/music')}
              className="text-sm text-purple-600 hover:text-purple-700 font-medium flex items-center gap-1 self-start sm:self-auto"
            >
              View All
          ...
          {dashboardData.recentActivity.length > 0 ? (
            <div className="space-y-3 sm:space-y-4">
              {dashboardData.recentActivity.map((activity, index) => (
                <div key={index} className="group flex items-center gap-3 sm:gap-4 p-2 sm:p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                  <div className={`p-2 sm:p-3 bg-gradient-to-br from-${activity.color}-100 to-${activity.color}-200 rounded-xl group-hover:scale-105 transition-transform duration-200`}>
                    <activity.icon className={`h-4 w-4 sm:h-5 sm:w-5 text-${activity.color}-600`} />
                  </div>
            ...
            <div className="text-center py-8 sm:py-12">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-100 to-purple-200 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              ...
              <p className="text-sm sm:text-base text-gray-500 mb-3 sm:mb-4">Start your musical journey by uploading your first track!</p>
              <button 
                onClick={() => navigate('/dashboard/upload')}
                className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 text-sm bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors duration-200"
              >
                <Upload className="h-3 w-3 sm:h-4 sm:w-4" />
                Upload Music
              </button>
