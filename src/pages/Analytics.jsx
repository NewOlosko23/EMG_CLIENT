    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm sm:text-base text-gray-600 mt-1">Track your music performance and growth</p>
        </div>
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          ...
          <button className="bg-purple-600 text-white px-3 sm:px-4 py-2 text-sm rounded-lg hover:bg-purple-700 transition-colors flex items-center justify-center gap-2">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
        <div className="bg-white p-3 sm:p-4 lg:p-6 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{analyticsData.totalPlays.toLocaleString()}</p>
            </div>
            <div className="p-2 sm:p-3 bg-blue-100 rounded-lg">
              <Play className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-600" />
            </div>
          </div>
          <div className="flex items-center mt-2">
            <TrendingUp className="h-3 w-3 sm:h-4 sm:w-4 text-green-500 mr-1" />
            <span className="text-xs sm:text-sm text-green-600 font-medium">+{analyticsData.playGrowth}%</span>
        ...
        <div className="bg-white p-3 sm:p-4 lg:p-6 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm text-gray-600">Total Listeners</p>
              <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{analyticsData.totalListeners.toLocaleString()}</p>
            </div>
          ...
          <div className="flex items-center mt-2">
            <TrendingUp className="h-3 w-3 sm:h-4 sm:w-4 text-green-500 mr-1" />
            <span className="text-xs sm:text-sm text-green-600 font-medium">+{analyticsData.listenerGrowth}%</span>
            <span className="text-xs sm:text-sm text-gray-500 ml-1 hidden sm:inline">vs last period</span>
          </div>
        </div>
        ...
        <div className="bg-white p-3 sm:p-4 lg:p-6 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{analyticsData.totalFollowers.toLocaleString()}</p>
            </div>
          ...
          <div className="flex items-center mt-2">
            <TrendingUp className="h-3 w-3 sm:h-4 sm:w-4 text-green-500 mr-1" />
            <span className="text-xs sm:text-sm text-green-600 font-medium">+{analyticsData.followerGrowth}%</span>
            <span className="text-xs sm:text-sm text-gray-500 ml-1 hidden sm:inline">vs last period</span>
          </div>
        </div>
        ...
        <div className="bg-white p-3 sm:p-4 lg:p-6 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">${analyticsData.totalRevenue.toLocaleString()}</p>
            </div>
          ...
          <div className="flex items-center mt-2">
            <TrendingUp className="h-3 w-3 sm:h-4 sm:w-4 text-green-500 mr-1" />
            <span className="text-xs sm:text-sm text-green-600 font-medium">+{analyticsData.revenueGrowth}%</span>
            <span className="text-xs sm:text-sm text-gray-500 ml-1 hidden sm:inline">vs last period</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Top Tracks</h3>
              ...
              <div key={index} className="flex items-center justify-between">
                <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs sm:text-sm font-medium text-gray-900 truncate">{track.name}</p>
                ...
                <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
                  ...
                  <span className={`text-xs sm:text-sm font-medium ${track.growth > 0 ? 'text-green-600' : 'text-red-600'}`}>
              ...
              <div key={index} className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                    ...
                    <span className="text-xs sm:text-sm font-medium text-gray-900 truncate">{country.country}</span>
                  </div>
                  <div className="text-right flex-shrink-0">
                    <p className="text-xs sm:text-sm font-medium text-gray-900">{country.plays.toLocaleString()}</p>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
        <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Platform Performance</h3>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
          {platforms.map((platform, index) => (
            <div key={index} className="text-center">
              <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gray-100 rounded-lg flex items-center justify-center mx-auto mb-2 sm:mb-3">
                <BarChart3 className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-gray-600" />
              </div>
              <h4 className="text-xs sm:text-sm font-medium text-gray-900 mb-1">{platform.name}</h4>
              <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-1">{platform.plays.toLocaleString()}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Plays Over Time</h3>
        ...
        {/* Top Tracks Chart */}
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Top Tracks Performance</h3>
          <div className="h-64 sm:h-72 lg:h-80">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
        <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Platform Distribution</h3>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <div className="h-64 sm:h-72 lg:h-80">
              ...
              {platforms.map((platform, index) => (
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                    ...
                    ></div>
                    <span className="text-xs sm:text-sm font-medium text-gray-900 truncate">{platform.name}</span>
                  </div>
                  <div className="text-right flex-shrink-0">
                    <p className="text-xs sm:text-sm font-semibold text-gray-900">{platform.plays.toLocaleString()}</p>
