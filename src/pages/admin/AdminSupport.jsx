                  ...
                  <tr key={ticket.id} className="hover:bg-gray-50">
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                          ...
                          <div className="text-xs text-gray-400 truncate sm:hidden">
                            {ticket.category} • {formatTimeAgo(ticket.createdAt)}
                          </div>
                        </div>
                      </div>
                    </td>
                    <td className="hidden sm:table-cell px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div>
                          <div className="text-sm font-medium text-gray-900 truncate">{ticket.user.name}</div>
                          <div className="text-sm text-gray-500 truncate">{ticket.user.email}</div>
                        </div>
                      </div>
                    </td>
              ...
              <div className="space-y-4">
                {selectedTicket.messages.map((message, index) => (
                  <div key={index} className={`flex ${message.sender === 'user' ? 'justify-start' : 'justify-end'}`}>
                    <div className={`max-w-xs sm:max-w-md lg:max-w-lg px-3 sm:px-4 py-2 rounded-lg ${
                      message.sender === 'user' 
